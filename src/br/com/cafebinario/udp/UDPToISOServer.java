...
public class UDPToISOServer implements IServer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			LAYOUT_XML.instanceOf().load();
		} catch (IOException e) {
			e.printStackTrace();
		}

		UDPToISOServer frm = new UDPToISOServer();
	...
	public void run() {
		...
		try {
			...
			while (!"exit".equals(exit.toLowerCase())) {
				...
				DispacherToISOUDP dispacher = new DispacherToISOUDP(channel);
