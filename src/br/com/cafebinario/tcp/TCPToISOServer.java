...
public class TCPToISOServer implements IServer {
	...
	public void run() {
		...
		try {
			...
			while (!"exit".equals(exit.toLowerCase())) {
				...
				ChannelTCP channel = new ChannelTCP(clientSocket, is,
						new Notify() {
				...
				DispacherToISOTCP dispacher = new DispacherToISOTCP(channel);
